  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      <header className="fixed top-0 left-0 w-full z-50 backdrop-blur-lg bg-white/80 shadow-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          <div className="flex items-center space-x-3">
            <img src="../public/images/workspace_logo.jpg" alt="logo" className="w-10 h-10" />
      ...
      <section className="relative w-full h-screen mt-16">
        <Slider {...settings}>
          {[
            { img: "../public/images/work_space_image_1.jpg", title: "Work Smarter, Together", desc: "Premium coworking spaces designed for productivity, collaboration, and growth." },
            { img: "../public/images/cws-2.webp", title: "Flexible Plans", desc: "Choose from daily, weekly, or monthly rentals that fit your needs." },
